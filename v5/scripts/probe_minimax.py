#!/usr/bin/env python3
"""Measure what this MiniMax deployment can actually do (v5 04).

The load-bearing check is #3: v5 01 requires L3 to see the clip *and* the
...
def main() -> int:
    ...
    # 3. video AND text in one request — the requirement v5 01 turns on
    try:
        clip = make_clip(5.0)
