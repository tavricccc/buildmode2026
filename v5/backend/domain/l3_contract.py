"""L3 escalation contracts (v5 01 §L3).

The evidence bundle is the load-bearing part of v5: MiniMax must see the
...
#: anything actually happens (v5 02: "模型不能直接發通知").
RECOMMENDATIONS = (
    "no_action",
    "keep_observing",
...
class EvidenceBundle:
    ...
    v5 01 lists the normal contents: clip, the L2 structured result, the
