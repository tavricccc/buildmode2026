"""L2 service: one window in, one validated observation out (v5 01 §L2).

The only interesting decision here is the repair path. v5 01 allows
...
* still invalid       -> status ``invalid``. v5 01: the event state is
