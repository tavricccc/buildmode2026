"""Repositories over the v5 schema (v5 02).
...
class Repositories:
    ...
    def run_stats(self, since_ms: int) -> dict[str, Any]:
        """The counters the Dashboard's three-layer panel renders (v5 03)."""
    ...
    def upsert_event(
        ...
        (v5 00 item 11), so identity is the dedup key, never the row id.
        """
