#!/usr/bin/env python3
"""Measure what this Gemini deployment can actually do (docs/04_SETUP_DEPLOY_VERIFY.md).
...
5. native audio input — docs/01_PIPELINE.md is explicit that "一定理解音訊" may not be
