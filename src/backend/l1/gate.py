"""The debounced person gate (docs/01_PIPELINE.md §L1, docs/00_SCOPE_AND_DEFINITION_OF_DONE.md items 3–5).
...
answered yields ``unavailable``, which also does not permit a skip. docs/00_SCOPE_AND_DEFINITION_OF_DONE.md
