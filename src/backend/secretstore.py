"""Write-only secret store (docs/03_API_AND_FRONTEND.md §Setup/Settings, docs/04_SETUP_DEPLOY_VERIFY.md §Secrets).
...
class SecretStore:
    ...
    def describe(self) -> dict[str, dict[str, object]]:
        """The *only* shape an API response may contain (docs/03_API_AND_FRONTEND.md)."""
