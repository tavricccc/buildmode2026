"""The scenarios docs/04_SETUP_DEPLOY_VERIFY.md §必測情境 names, end to end.
...
class TestFallBypassesL1(CascadeCase):
    ...
    def test_hydration_does_not_trigger_the_high_risk_bypass(self):
        # docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 8 names fall specifically. Nobody is harmed by
...
class TestAuditTrail(CascadeCase):
    """docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 10: any window must be fully reconstructible."""
    ...
    def test_replaying_the_same_footage_does_not_double_count(self):
        """docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 11: replay reset must be idempotent."""
        self.harness = Harness()
        self.harness.play(HYDRATION_SCENARIO)
