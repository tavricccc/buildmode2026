"""L1 person gate (docs/01_PIPELINE.md §L1, docs/00_SCOPE_AND_DEFINITION_OF_DONE.md items 3-5)."""
...
class TestFailOpen(unittest.TestCase):
    """docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 5: a broken detector must never read as an empty room."""
