"""L2 and L3 services: repair, failure and degradation (docs/01_PIPELINE.md)."""
...
class TestL3(unittest.TestCase):
    ...
    def test_a_timeout_returns_a_result_and_never_raises(self):
        """docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 9: L3 failing must not stop the pipeline."""
