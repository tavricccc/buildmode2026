"""Minimal RFC 6455 server for Dashboard push (docs/03_API_AND_FRONTEND.md).

docs/03_API_AND_FRONTEND.md asks for WebSocket push with REST resync, and the backend is
...
Broadcast order matters and is guaranteed by the caller, not here: docs/03_API_AND_FRONTEND.md
...
class Broadcaster:
    ...
    Dashboard's own REST resync is the recovery path (docs/03_API_AND_FRONTEND.md).
    """
