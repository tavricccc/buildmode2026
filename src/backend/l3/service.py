"""L3 service: escalation-only deep analysis (docs/01_PIPELINE.md §L3, docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 9).

Two guarantees this module owns:

*Video reaches the model.* docs/01_PIPELINE.md says MiniMax must see the clip itself,
...
with a call record; nothing raises past this boundary. docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 9: a
