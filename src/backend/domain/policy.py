"""Deterministic thresholds (docs/02_DATA_AND_POLICY.md §Policy Gateway).
...
class L1Policy:
    """Person-gate behaviour (docs/01_PIPELINE.md §L1)."""
...
@dataclass(frozen=True)
class CadencePolicy:
    """How often each layer is allowed to run (src/README.md §排程)."""
...
class EscalationPolicy:
    """When L3 may be spent (docs/01_PIPELINE.md §L3)."""
...
class NotificationPolicy:
    ...
    #: never add to this list; only Settings can (docs/02_DATA_AND_POLICY.md §Telegram).
