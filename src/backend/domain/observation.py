"""L2 structured observation contract (docs/01_PIPELINE.md §L2).
...
1. An observation is *evidence*, never a confirmed event. Only the
   ...
   (docs/00_SCOPE_AND_DEFINITION_OF_DONE.md: "不讓 Gemini 或 MiniMax 直接建立 confirmed event").
...
class Escalation(Schema):
    """L2's request for a deeper L3 look (docs/01_PIPELINE.md §L2)."""
