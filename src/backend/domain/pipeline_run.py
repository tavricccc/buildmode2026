"""``pipeline_runs`` — the audit record (docs/02_DATA_AND_POLICY.md).

One row per vision window. docs/00_SCOPE_AND_DEFINITION_OF_DONE.md item 10 is the requirement this exists
