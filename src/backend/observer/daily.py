"""Daily rollup and baseline comparison (docs/02_DATA_AND_POLICY.md §Observer).

The cost rule is the interesting part. docs/02_DATA_AND_POLICY.md says the observer may call
