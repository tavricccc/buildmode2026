...
- 顯示 RTSP live camera；可切換 replay 測試模式。
...
- 顯示 camera、vision loop、frame age、dropped windows、mic、VAD、Whisper、Qwen-VL、MiniMax、scheduler 與 DB 狀態。
...
- 設定 camera、vision loop interval/window、MiniMax、Telegram 與風險時間窗。
